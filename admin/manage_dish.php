...
?>
<div class="row">
			<h1 class="grid_title ml10 ml15">Products</h1>
                ...
                <div class="card-body">
                  <form class="forms-sample" method="post" enctype="multipart/form-data">
					...
					<div class="form-group">
                      ...
                      <input type="text" class="form-control" placeholder="product name" name="dish" required value="<?php echo $dish?>">
                    ...
                    <div class="form-group">
                      ...
                      <textarea name="dish_detail" class="form-control" placeholder="product detail"><?php echo $dish_detail?></textarea>
                    </div>
					<div class="form-group">
