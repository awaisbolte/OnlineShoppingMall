                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-8 col-md-8 col-12 col-sm-8">
                            <div class="account-curr-lang-wrap f-right">
								...
								?>
								<ul>
                                    <li class="top-hover"><a href="#"><?php echo "Welcome <span id='user_top_name'> </span>".$_SESSION['FOOD_USER_NAME'];?> <i class="ion-chevron-down"></i></a>
                                        <ul>
                        ...
                        <div class="col-lg-3 col-md-4 col-12 col-sm-4">
                            <div class="logo">
                                <a href="<?php echo FRONT_SITE_PATH?>">
                                    <img alt="" src="<?php echo FRONT_SITE_PATH?>assets/img/logo/OSM-Footer.png" width="50%"> 
                                </a>
                            </div>
                        </div>
